<%-- 
    Document   : ClienteMasJoven
    Created on : 6/10/2021, 12:13:04 p. m.
    Author     : alex
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    ...
                    <h1 class="mt-4 mb-5">El nombre y la edad del cliente más joven.</h1>
                        ...
                        <tbody>
                            <%
                                if (Banco.banco.getPersonas().size() > 0) {
                                    ...
                                    Persona masjoven = Banco.banco.getPersonas().get(0);
                            ...
                            <tr>
                                <th scope="row">1</th>
                                <td><%=masjoven.getNombre()%></td>
                                <td><%=masjoven.obtIdentificacion()%></td>
                                <td><%=masjoven.getEdad()%></td>
                            </tr>
                            <%

<%-- 
    ...
    Created on : 6/10/2021, 9:47:36 a. m.
    Author     : alex
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    ...
                    <h1 class="mt-4 mb-5">Todos los nombres y cédulas de las personas clientes del banco.</h1>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Cédula de ciudadania</th>
